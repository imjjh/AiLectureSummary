...
export default function Page() {
  ...
  const [hasSession, setHasSession] = useState(true) // 기본값 true로, 쿠키 체크 후 false로 바꿈
  ...
  // 클라이언트에서 인증 쿠키 체크
  useEffect(() => {
    // 예시: 'session' 쿠키가 있는지 확인
    const cookieStr = typeof document !== "undefined" ? document.cookie : ""
    const isLoggedIn = cookieStr.split(";").some(cookie => cookie.trim().startsWith("session="))
