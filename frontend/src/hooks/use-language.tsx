...
const translations: Record<string, Record<string, string>> = {
  ...
  ja: {
    ...
    analyze: "AI分析",
    summary: "要約結果",
    upload_video: "動画ファイルをアップロードしてください",
    drag_drop: "ファイルをドラッグ＆ドロップまたはクリックして選択",
    select_file: "ファイル選択",
    start_summary: "要約開始",
    key_summary: "ポイント要約",
    full_summary: "全体要約",
    ...
    settings: "設定",
    profile: "プロフィール",
    service_title: "動画講義要約サービス",
    service_description: "AIが動画講義を分析し、重要な内容を要約します",
  },
  zh: {
    home: "首页",
    about: "服务介绍",
    ...
    settings: "设置",
    profile: "个人资料",
    service_title: "视频讲座摘要服务",
    service_description: "AI分析视频讲座并为您总结关键内容",
  },
}
